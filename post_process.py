...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", help="Input file path generated by bcftools roh --output-type r")
    parser.add_argument("-o", "--output", help="Output file with added genetic positions", default=None)
    parser.add_argument("-p", "--output-proccesse", help="Output file with postprocessed ROH", default=None)
    parser.add_argument("-m", "--genetic_map", help="Genetic map file", default=None)
    ...
    for chr in range(1, 21):
        ...
        df_chr['StartM'] = interpol_gen_pos(df_chr['StartBP'], genetic_map)
        df_chr['EndM'] = interpol_gen_pos(df_chr['EndBP'], genetic_map)
        df_chr['lengthM'] = df_chr['EndM'] - df_chr['StartM']
